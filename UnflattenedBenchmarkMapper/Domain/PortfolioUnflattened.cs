...
{
    public class PortfolioUnflattened
    {
        [Key]
        ...
        public StringPropertiesUnflattened GroupStringProperties { get; set; }
        public IntPropertiesUnflattened GroupIntProperties { get; set; }
        public DecimalPropertiesUnflattened GroupDecimalProperties { get; set; }
        public DateTimePropertiesUnflattened GroupDateTimeProperties { get; set; }
    }

    public class DecimalPropertiesUnflattened
    {
    ...
    public class IntPropertiesUnflattened
    {
    ...
    public class StringPropertiesUnflattened
    {
    ...
    public class DateTimePropertiesUnflattened
    {
